 ...
 */
class DocumentRevisionRevertForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new DocumentRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'document_revision_revert_confirm';
  }
   ...
   *
   * @param \Drupal\document_mgmt\Entity\DocumentInterface $revision
